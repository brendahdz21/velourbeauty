    ...
    <div class="admin-panel">
        ...
        <section class="admin-content">
            ...
            <div class="register-header">
                <div>
                    <h1 class="register-title">Registrar Marca</h1>
                    <p class="register-subtitle">Aquí puedes registrar nuevas marcas dentro del sistema.</p>
                </div>
            ...
            <div class="register-card">
                <form action="{{ route('admin.marcas.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="register-actions">
                        <a href="{{ route('admin.marcas') }}" class="btn-cancel-register">Cancelar</a>
