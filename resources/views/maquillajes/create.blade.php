...
<head>
    ...
    <title>Registro de Maquillaje</title>
</head>
<body>
    ...
    <div class="admin-panel">
        ...
        <section class="admin-content">
            ...
            <div class="register-header">
                <div>
                    <h1 class="register-title">Registrar Maquillaje</h1>
                    <p class="register-subtitle">
                        Aquí puedes registrar nuevos maquillajes dentro del sistema.
                    </p>
                </div>
            ...
            <div class="register-card">
                <form action="{{ route('maquillajes.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
